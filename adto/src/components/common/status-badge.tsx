...
const statusStyles: Record<string, string> = {
  ...
  IN_PROGRESS: "border-ace-blue/20 bg-ace-blue/10 text-ace-blue",
  NOT_STARTED: "border-warning/20 bg-warning/10 text-warning",
  PENDING: "border-warning/20 bg-warning/10 text-warning",
  FOR_VERIFICATION: "border-warning/20 bg-warning/10 text-warning",
  DRAFT: "border-warning/20 bg-warning/10 text-warning",
  SUBMITTED: "border-ace-blue/20 bg-ace-blue/10 text-ace-blue",
  CHECKED: "border-success/20 bg-success/10 text-success",
  NEEDS_REVISION: "border-error/20 bg-error/10 text-error",
