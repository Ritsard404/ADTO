...
export const mockSchools = [
  {
    ...
    deployedFormId: "CIC-G-2025",
    formNumber: "G-001",
    sourceSchoolId: "gorordo",
    schoolLogoFileId: "legacy-logo-gorordo",
    team: "Visayas ACE",
    unitHead: "ACE Unit Head",
    supervisor: "CIC Supervisor",
    supervisorEmail: "supervisor.gorordo@adto.local",
    edtechSpecialist: "CIC EdTech Specialist",
    edtechEmail: "edtech.gorordo@adto.local",
    gradeLevelAdoption: "Grade School and High School",
    adoptionRemarks: "Workbook baseline mock setup.",
  ...
  },
  {
    ...
    deployedFormId: "CIC-M-2025",
    formNumber: "M-001",
    sourceSchoolId: "mandaue",
    schoolLogoFileId: "legacy-logo-mandaue",
    team: "Visayas ACE",
    unitHead: "ACE Unit Head",
    supervisor: "Mandaue Supervisor",
    supervisorEmail: "supervisor.mandaue@adto.local",
    edtechSpecialist: "Mandaue EdTech Specialist",
    edtechEmail: "edtech.mandaue@adto.local",
    gradeLevelAdoption: "Grade School",
    adoptionRemarks: "Workbook baseline mock setup.",
...
export const mockInventoryItems = [
  {
    ...
    totalQuantity: 10,
    unit: "sets",
    borrowedStatus: "Not borrowed",
    completenessStatus: "Complete",
    facilitatorSignOff: "Francis Justin Cutamora",
    condition: "GOOD" as InventoryCondition,
    remarks: "Complete and working.",
    sourceKey: "mock-inventory-1",
    sourceSheet: "GS-i",
    sourceWorkbookFile: "Mock ADMS workbook",
    sourceRowRange: "GS-i!8:8",
    sourceDeployedFormId: "CIC-G-2025",
    importedAt: new Date("2025-06-01"),
