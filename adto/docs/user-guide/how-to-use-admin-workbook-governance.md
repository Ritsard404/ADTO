# How to use admin workbook governance

## What this feature does

The admin dashboard turns the legacy ADMS workbook checks into an all-school ADTO view. It shows workbook-style implementation health, assignment coverage, setup gaps, import preview notes, data quality issues, audit activity, approvals, and report history.

## When to use it

Use it before report generation, after workbook imports, during facilitator reassignment reviews, or when checking which schools need attention.

## Before you begin

Sign in as an admin. Make sure school records, facilitator assignments, sessions, projects, inventory, and reports have been entered or imported.
...
Corrected records are reflected on the dashboard, official reports, and facilitator workspaces after the page refreshes.
...
If a school shows a zero-state row, it means the school exists but does not yet have sessions, projects, teachers, or inventory attached. Add or import the missing records from the matching module.
